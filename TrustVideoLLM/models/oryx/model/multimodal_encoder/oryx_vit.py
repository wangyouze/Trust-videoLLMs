...
def create_siglip_vit(
    ...
    **kwargs,
    ...
    if path is not None and os.path.exists(path):
        ...
        path = '/data1/home/wangyouze/projects/checkpoints/Oryx-ViT/'
...
class OryxViTWrapper(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained("/data1/home/wangyouze/projects/checkpoints/clip-vit-large-patch14/")
