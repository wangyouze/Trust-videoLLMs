...
jsonlist = glob("logs/truthfulness/t2-video-caption/{}/*.json".format(args.model_id))
outfile = "results/truthfulness/t2-video-caption/{}/t2-video-caption.json".format(args.model_id)
