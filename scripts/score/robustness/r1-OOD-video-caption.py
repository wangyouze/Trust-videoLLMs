...
jsonlist = glob("logs/robustness/r1-ood-video/{}/*.json".format(args.model_id))
outfile = "results/robustness/r1-ood-video/{}/r1-ood-artistic.json".format(args.model_id)
...
keyname_mapping = {
    ...
    "bleu_meteor_cider_spice_eval:blue_rouge_meteor_cider_spice": "bleu",
}
