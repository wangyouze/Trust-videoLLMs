...
jsonlist = glob("logs/privacy/p4-privacy-inference-openvid/{}/*.json".format(args.model_id))
outfile = "results/privacy/p4-privacy-inference/{}/p4-inference.json".format(args.model_id)
