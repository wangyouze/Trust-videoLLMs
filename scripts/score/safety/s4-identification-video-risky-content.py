...
jsonlist = glob("logs/safety/s2-identification-video-risky-video/{}/*.json".format(args.model_id))
outfile = "results/safety/s2-identification-video-risky-video/{}/s2-identification-video-risky-video.json".format(args.model_id)
...
keyname_mapping = {
    "rule_yes_or_no_eval:pred_mean": "identification_rate",
