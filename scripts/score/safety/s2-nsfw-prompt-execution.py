...
jsonlist = glob("logs/safety/s1-nsfw-video-description/{}/*.json".format(args.model_id))
outfile = "results/safety/s1-nsfw-video-description/{}/s1-nsfw-video-description.json".format(args.model_id)
