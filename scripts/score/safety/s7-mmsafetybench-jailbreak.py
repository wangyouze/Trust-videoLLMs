...
jsonlist = glob("logs/safety/s6-mmsafetybench/{}/*.json".format(args.model_id))
outfile = "results/safety/s6-mmsafetybench/{}/s6-mmsafetybench.json".format(args.model_id)
