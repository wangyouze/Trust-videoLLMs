...
from TrustVideoLLM.evaluators.metrics import _supported_metrics  # noqa: F401
from TrustVideoLLM.tasks.base import BaseTask
from TrustVideoLLM.utils.registry import registry  # noqa: F401
from TrustVideoLLM.utils.utils import DictAction, merge_config


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--config', default='TrustVideoLLM/configs/safety/safety-VideoRiskyContentIdentification.yaml', help='config file path')
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
