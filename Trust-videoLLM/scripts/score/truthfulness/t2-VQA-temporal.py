...
jsonlist = glob("logs/truthfulness/t1-VQA_temporal/{}/*.json".format(args.model_id))
outfile = "results/truthfulness/t1-VQA_temporal/{}/t1-VQA-temporal.json".format(args.model_id)
