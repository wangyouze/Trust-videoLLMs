...
if not os.path.exists("logs/truthfulness/t1-VQA-contextual/{}".format(args.model_id)):
    print('please check the path')
    exit()
jsonlist = glob("logs/truthfulness/t1-VQA-contextual/{}/*.json".format(args.model_id))
outfile = "results/truthfulness/t1-VQA-contextual/{}/t1-VQA-contextual.json".format(args.model_id)
