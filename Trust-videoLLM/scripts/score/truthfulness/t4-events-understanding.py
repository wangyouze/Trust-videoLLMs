...
jsonlist = glob("logs/truthfulness/t3-events-understanding/{}/*.json".format(args.model_id))
outfile = "results/truthfulness/t3-events-understanding/{}/t3-events-understanding.json".format(args.model_id)
...
keyname_mapping = {
    "rule_yes_or_no_eval:pred_mean": "accuracy",
}
