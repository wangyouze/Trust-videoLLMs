...
jsonlist = glob("logs/safety/s4-toxicity-content-generation/{}/*.json".format(args.model_id))
outfile = "results/safety/s4-toxicity-content-generation/{}/s4-toxicity-content-generation.json".format(args.model_id)
