...
jsonlist = glob("logs/safety/s1-nsfw-prompt-generation/{}/*.json".format(args.model_id))
outfile = "results/safety/s1-nsfw-prompt-generation/{}/s1-nsfw-prompt-generation.json".format(args.model_id)
