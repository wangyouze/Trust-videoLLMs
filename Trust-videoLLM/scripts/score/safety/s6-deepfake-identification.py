...
jsonlist = glob("logs/safety/s5-deepfake-identification/{}/*.json".format(args.model_id))
outfile = "results/safety/s5-deepfake-identification/{}/s5-deepfake-identification.json".format(args.model_id)
