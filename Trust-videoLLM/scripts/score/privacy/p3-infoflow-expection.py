...
jsonlist = glob("logs/privacy/p2-privacy-infoflow-expection/{}/*.json".format(args.model_id))
outfile = "results/privacy/p2-privacy-infoflow-expection/{}/p2-infoflow.json".format(args.model_id)
