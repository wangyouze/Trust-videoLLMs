...
jsonlist = glob("logs/fairness/f3-profession-pred/{}/*.json".format(args.model_id))
outfile = "results/fairness/f3-profession-pred/{}/f3-profession-pred.json".format(args.model_id)
