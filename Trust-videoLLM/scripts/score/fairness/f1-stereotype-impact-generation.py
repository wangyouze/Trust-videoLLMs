...
jsonlist = glob("logs/fairness/f1-stereotype-impact-generation/{}/*.json".format(args.model_id))
outfile = "results/fairness/f1-stereotype-impact-generation/{}/f1-stereotype-impact-generation.json".format(args.model_id)
