...
jsonlist = glob("logs/fairness/f5-time-sensitivity/{}/*.json".format(args.model_id))
outfile = "results/fairness/f5-time-sensitivity/{}/f5-time-sensitivity.json".format(args.model_id)
