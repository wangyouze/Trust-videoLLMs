...
jsonlist = glob("logs/robustness/r7-adversarial-texts/{}/*.json".format(args.model_id))
outfile = "results/robustness/r7-adversarial-texts/{}/r7-adversarial-texts".format(args.model_id)
