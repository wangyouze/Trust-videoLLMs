...
jsonlist = glob("logs/robustness/r3-temporal-consistency/{}/*.json".format(args.model_id))
outfile = "results/robustness/r3-temporal-consistency/{}/r3-temporal-consistency.json".format(args.model_id)
