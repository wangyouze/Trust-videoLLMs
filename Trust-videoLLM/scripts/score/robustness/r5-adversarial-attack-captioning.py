...
jsonlist = glob("logs/robustness/r5-targeted-attacks/{}/*.json".format(args.model_id))
outfile = "results/robustness/r5-targeted-attacks/{}/r4-untargeted-attacks.json".format(args.model_id)
