...
parser.add_argument('--model_id', type=str, default='LiveCC-7B-Instruct', help='Model ID to be processed')
args = parser.parse_args()


jsonlist = glob("logs/robustness/r6-sentiment-analysis/{}/*.json".format(args.model_id))
outfile = "results/robustness/r6-sentiment-analysis/{}/r6-sentiment-analysis".format(args.model_id)
