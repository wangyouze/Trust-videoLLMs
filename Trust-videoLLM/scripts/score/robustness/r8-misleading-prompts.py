...
jsonlist = glob("logs/robustness/r8-misleading-prompts/{}/*.json".format(args.model_id))
outfile = "results/robustness/r8-misleading-prompts/{}/r4-untargeted-attacks.json".format(args.model_id)
